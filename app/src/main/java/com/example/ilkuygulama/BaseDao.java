...
public class BaseDao extends SQLiteOpenHelper {
    ...
    public void createCustomerDao(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + CustomerEntity.tablo_kisiler + "(" + CustomerEntity.col_id + " INTEGER PRIMARY KEY AUTOINCREMENT, "
    ...
    public void createReservationDao(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + ReservationEntity.table_reservation + "(" + ReservationEntity.col_id + " INTEGER PRIMARY KEY AUTOINCREMENT, "
    ...
    public void createVehicleDao(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + VehicleEntity.table_vehicles + "(" + VehicleEntity.col_id + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                +VehicleEntity. col_plate + " TEXT NOT NULL, "
                + VehicleEntity.col_driver + " TEXT NOT NULL, "
                +VehicleEntity. col_firstCity + " TEXT NOT NULL, "
                + VehicleEntity.col_endCity +" DATE NOT NULL)");
    }
}
